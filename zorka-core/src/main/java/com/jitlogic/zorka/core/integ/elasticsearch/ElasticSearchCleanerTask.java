 ...
 *
 */
public class ElasticSearchCleanerTask implements Runnable {

    /**
     * Logger
     */
    private static final ZorkaLog log = ZorkaLogger.getLog(ElasticSearchCleanerTask.class);

    private ConcurrentLinkedQueue<ElasticSearchCheckResult> responseQueue;

    private int maxCacheSize;

    public ElasticSearchCleanerTask(ConcurrentLinkedQueue<ElasticSearchCheckResult> responseQueue, int maxCacheSize) {
