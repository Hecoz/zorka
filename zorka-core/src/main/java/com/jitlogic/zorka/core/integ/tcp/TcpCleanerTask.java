 ...
 *
 */
public class TcpCleanerTask implements Runnable {

    /**
     * Logger
     */
    private static final ZorkaLog log = ZorkaLogger.getLog(TcpCleanerTask.class);

    private ConcurrentLinkedQueue<CheckResult> responseQueue;

    private int maxCacheSize;

    public TcpCleanerTask(ConcurrentLinkedQueue<CheckResult> responseQueue, int maxCacheSize) {
