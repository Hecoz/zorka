 ...
 */
public class TcpFullTraceClientConnector extends TcpFullTraceConnector {
     ...
     */
    public TcpFullTraceClientConnector(String addr, int port) throws IOException {
     ...
     */
    public TcpFullTraceClientConnector(String addr, int port, int socketTimeout) throws IOException {
...
//    }
    ...
    /**
     * Sends HELLO packet and awaits reply. This is equivalent of 'log in' to ZICO server. No
     * communication or data submission (except for PING) is possible prior to this operation.
     *
...
//    }
     ...
     * @throws IOException if connection breaks or server error occurs when processing submitted
     *                     data;
     */
    public void submit(Object data) throws IOException {
        ...
        send(ZicoCommonUtil.pack(data));
//        ZicoPacket pkt = recv();
//        if (pkt.getStatus() != ZICO_OK) {
//            throw new ZicoException(pkt.getStatus(), "ZICO submission error: status=" + pkt.
//                    getStatus());
//        }
    }
